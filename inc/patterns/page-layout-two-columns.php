 ...
 */
return array(
	'title'      => __( 'Page layout with two columns', 'sitetheme' ),
	...
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var(--wp--custom--spacing--large, 8rem)","bottom":"var(--wp--custom--spacing--large, 8rem)"}}},"layout":{"inherit":true}} -->
					...
					<h1 class="alignwide" style="font-size:clamp(4rem, 15vw, 12.5rem);font-weight:200;line-height:1">' . wp_kses_post( __( '<em>Goldfinch </em><br><em>&amp; Sparrow</em>', 'sitetheme' ) ) . '</h1>
					<!-- /wp:heading -->
					...
					<p>' . esc_html__( 'WELCOME', 'sitetheme' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column -->
					...
					<p>' . esc_html__( 'POSTS', 'sitetheme' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column --></div>
					<!-- /wp:columns -->

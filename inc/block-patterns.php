 ...
 * @return void
 */
function sitetheme_register_block_patterns() {
	$block_pattern_categories = array(
		'featured' => array( 'label' => __( 'Featured', 'sitetheme' ) ),
		'footer'   => array( 'label' => __( 'Footers', 'sitetheme' ) ),
		'header'   => array( 'label' => __( 'Headers', 'sitetheme' ) ),
		'query'    => array( 'label' => __( 'Query', 'sitetheme' ) ),
		'pages'    => array( 'label' => __( 'Pages', 'sitetheme' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'sitetheme_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'sitetheme_block_patterns', $block_patterns );

	foreach ( $block_patterns as $block_pattern ) {
		$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

		register_block_pattern(
			'sitetheme/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action( 'init', 'sitetheme_register_block_patterns', 9 );
